    ...
    <div className="overflow-hidden rounded-lg border border-amber-500/30 bg-zinc-950/50 ring-1 ring-amber-500/10">
      <div className="space-y-3 px-4 py-3">
        <div className="flex flex-wrap items-center gap-2">
          <Badge variant="warning">Proposed clip #{rank}</Badge>
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start gap-3 rounded-lg border border-amber-500/20 bg-amber-500/5 px-4 py-3">
        ...
        <div>
          <p className="text-sm font-medium text-amber-100">Proposed clip candidates</p>
          <p className="mt-1 text-sm text-amber-100/80">
            These are ranked transcript ranges selected for short-form editing. No video has been
            cut or rendered yet.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg border border-zinc-800 bg-zinc-950/60 p-4">
          <p className="text-xs uppercase tracking-wider text-zinc-500">Candidates</p>
